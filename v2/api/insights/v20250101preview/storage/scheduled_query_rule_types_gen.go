...
// Storage version of v20250101preview.ScheduledQueryRule
...
// Storage version of v20250101preview.APIVersion
...
type augmentConversionForScheduledQueryRule interface {
	AssignPropertiesFrom(src *storage.ScheduledQueryRule) error
	AssignPropertiesTo(dst *storage.ScheduledQueryRule) error
}

// Storage version of v20250101preview.ScheduledQueryRule_Spec
...
// Storage version of v20250101preview.ScheduledQueryRule_STATUS
...
// Storage version of v20250101preview.Actions
...
// Storage version of v20250101preview.Actions_STATUS
// Actions to invoke when the alert fires.
...
type augmentConversionForScheduledQueryRule_Spec interface {
	AssignPropertiesFrom(src *storage.ScheduledQueryRule_Spec) error
	AssignPropertiesTo(dst *storage.ScheduledQueryRule_Spec) error
}

type augmentConversionForScheduledQueryRule_STATUS interface {
	AssignPropertiesFrom(src *storage.ScheduledQueryRule_STATUS) error
	AssignPropertiesTo(dst *storage.ScheduledQueryRule_STATUS) error
}

// Storage version of v20250101preview.Identity
...
// Storage version of v20250101preview.Identity_STATUS
// Identity for the resource.
...
// Storage version of v20250101preview.RuleResolveConfiguration
...
// Storage version of v20250101preview.RuleResolveConfiguration_STATUS
// TBD. Relevant only for rules of the kind LogAlert.
...
// Storage version of v20250101preview.ScheduledQueryRuleCriteria
...
// Storage version of v20250101preview.ScheduledQueryRuleCriteria_STATUS
// The rule criteria that defines the conditions of the scheduled query rule.
...
// Storage version of v20250101preview.ScheduledQueryRuleOperatorSpec
...
// Storage version of v20250101preview.SystemData_STATUS
...
type augmentConversionForActions interface {
	AssignPropertiesFrom(src *storage.Actions) error
	AssignPropertiesTo(dst *storage.Actions) error
}

type augmentConversionForActions_STATUS interface {
	AssignPropertiesFrom(src *storage.Actions_STATUS) error
	AssignPropertiesTo(dst *storage.Actions_STATUS) error
}
...
type augmentConversionForRuleResolveConfiguration interface {
	AssignPropertiesFrom(src *storage.RuleResolveConfiguration) error
	AssignPropertiesTo(dst *storage.RuleResolveConfiguration) error
}

type augmentConversionForRuleResolveConfiguration_STATUS interface {
	AssignPropertiesFrom(src *storage.RuleResolveConfiguration_STATUS) error
	AssignPropertiesTo(dst *storage.RuleResolveConfiguration_STATUS) error
}

type augmentConversionForScheduledQueryRuleCriteria interface {
	AssignPropertiesFrom(src *storage.ScheduledQueryRuleCriteria) error
	AssignPropertiesTo(dst *storage.ScheduledQueryRuleCriteria) error
}

type augmentConversionForScheduledQueryRuleCriteria_STATUS interface {
	AssignPropertiesFrom(src *storage.ScheduledQueryRuleCriteria_STATUS) error
	AssignPropertiesTo(dst *storage.ScheduledQueryRuleCriteria_STATUS) error
}

type augmentConversionForScheduledQueryRuleOperatorSpec interface {
	AssignPropertiesFrom(src *storage.ScheduledQueryRuleOperatorSpec) error
	AssignPropertiesTo(dst *storage.ScheduledQueryRuleOperatorSpec) error
}
...
// Storage version of v20250101preview.Condition
...
// Storage version of v20250101preview.Condition_STATUS
// A condition of the scheduled query rule.
...
// Storage version of v20250101preview.UserAssignedIdentityDetails
...
// Storage version of v20250101preview.UserIdentityProperties_STATUS
...
type augmentConversionForCondition interface {
	AssignPropertiesFrom(src *storage.Condition) error
	AssignPropertiesTo(dst *storage.Condition) error
}

type augmentConversionForCondition_STATUS interface {
	AssignPropertiesFrom(src *storage.Condition_STATUS) error
	AssignPropertiesTo(dst *storage.Condition_STATUS) error
}
...
// Storage version of v20250101preview.Condition_FailingPeriods
...
// Storage version of v20250101preview.Condition_FailingPeriods_STATUS
...
// Storage version of v20250101preview.Dimension
...
// Storage version of v20250101preview.Dimension_STATUS
// Dimension splitting and filtering definition
...
type augmentConversionForCondition_FailingPeriods interface {
	AssignPropertiesFrom(src *storage.Condition_FailingPeriods) error
	AssignPropertiesTo(dst *storage.Condition_FailingPeriods) error
}

type augmentConversionForCondition_FailingPeriods_STATUS interface {
	AssignPropertiesFrom(src *storage.Condition_FailingPeriods_STATUS) error
	AssignPropertiesTo(dst *storage.Condition_FailingPeriods_STATUS) error
}

type augmentConversionForDimension interface {
	AssignPropertiesFrom(src *storage.Dimension) error
	AssignPropertiesTo(dst *storage.Dimension) error
}

type augmentConversionForDimension_STATUS interface {
	AssignPropertiesFrom(src *storage.Dimension_STATUS) error
	AssignPropertiesTo(dst *storage.Dimension_STATUS) error
}
